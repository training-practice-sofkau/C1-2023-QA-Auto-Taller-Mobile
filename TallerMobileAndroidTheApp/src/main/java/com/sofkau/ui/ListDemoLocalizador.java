...
public class ListDemoLocalizador {
    ...
    public static final Target BTN_MAYOR_QUE_LIST_DEMO = Target
            ...
            .located(xpath("//android.view.ViewGroup[@content-desc=\"List Demo\"]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView"));
